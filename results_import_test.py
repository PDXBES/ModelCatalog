...
simulation.scenario = ""
simulation_data_io.copy_node_results(simulation)
simulation_data_io.copy_link_results(simulation)
simulation_data_io.copy_node_flooding_results(simulation)
simulation_data_io.copy_area_results(simulation)