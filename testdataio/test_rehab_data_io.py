...
class TestRehabDataIo(TestCase):
    ...
    def setUp(self):
        ...
        self.patch_copy_to_memory = mock.patch("dataio.db_data_io.DbDataIo.copy_to_memory")
        ...
        self.patch_delete_field_management = mock.patch("arcpy.DeleteField_management")
        self.mock_delete_field_management = self.patch_delete_field_management.start()

        self.patch_MakeFeatureLayer_management = mock.patch("arcpy.MakeFeatureLayer_management")
        self.mock_MakeFeatureLayer_management = self.patch_MakeFeatureLayer_management.start()

        self.patch_CopyFeatures_management = mock.patch("arcpy.CopyFeatures_management")
        self.mock_CopyFeatures_management = self.patch_CopyFeatures_management.start()
    ...
    def tearDown(self):
        ...
        self.mock_delete_field_management = self.patch_delete_field_management.stop()
        self.mock_MakeFeatureLayer_management = self.patch_MakeFeatureLayer_management.stop()
        self.mock_CopyFeatures_management = self.patch_CopyFeatures_management.stop()

    def test_copy_rehab_results_from_nbcr_data_to_memory_calls_MakeFeatureLayer_management_with_correct_arguments(self):
        ...
        self.mock_MakeFeatureLayer_management.assert_called_with(input_table, intermediate_layer, where_clause, workspace)

    def test_copy_rehab_results_from_nbcr_data_to_memory_calls_CopyFeatures_management_with_correct_arguments(self):
        intermediate_layer = "intermediate"
        output_table_name = "output_table_name"
        output_table = "in_memory\\output_table_name"
        self.rehab_data_io.copy_rehab_results_from_nbcr_data_to_memory(output_table_name)
        self.mock_CopyFeatures_management.assert_called_with(intermediate_layer, output_table)

    def test_copy_rehab_results_from_nbcr_data_to_memory_calls_delete_field_management_with_correct_arguments(self):
        output_table_name = "output_table_name"
        output_table = "in_memory\\output_table_name"
        self.rehab_data_io.copy_rehab_results_from_nbcr_data_to_memory(output_table_name)
        self.mock_delete_field_management.assert_called_with(output_table, "BPW")
        ...
        with mock.patch.object(self.rehab_data_io,
            ...
            with mock.patch.object(self.rehab_data_io,
                ...
                with mock.patch.object(self.rehab_data_io,
                                       "copy_rehab_results_from_tv_ratings_to_memory"):
                    self.rehab_data_io.copy_rehab_results_to_memory(output_table_name, self.mock_rehab)
                    self.mock_add_parent_id.assert_called_with(output_table, "rehab_id", 1)
