...
class TestRradDataIO(TestCase):
    def setUp(self):
        ...
        self.patch_create_rehab_results = mock.patch("businessclasses.rehab.Rehab.create_rehab_result")
    ...
    def test_retrieve_current_rehab_id(self):
        ...
        current_model_id = self.rrad_db_data_io.retrieve_current_rehab_id()
        self.assertTrue(current_model_id == 44)

    def test_add_rehab_calls_append_object_with_correct_arguments(self):
        self.rrad_db_data_io.add_rehab(self.mock_rehab)
    ...
    def test_add_rehab_calls_create_rehab_result_with_correct_arguments(self):
        rehab_id = 1
        self.rrad_db_data_io.add_rehab(self.mock_rehab)
        self.mock_create_rehab_results.assert_called_with(rehab_id)
