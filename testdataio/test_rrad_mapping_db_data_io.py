...
class TestRradMappingDbDataIo(TestCase):
    def setUp(self):
        ...
        self.mock_rrad = mock.MagicMock(Rrad)
        self.mock_rehab = mock.MagicMock(Rehab)
        self.mock_rehab.id = 1
        self.mock_rrad.create_rehab_for_characterization.return_value = self.mock_rehab
    ...
    def test_add_mapping_snapshot_calls_create_rehab_for_characterization_called_with_correct_arguments(self):
        self.rrad_mapping_db_data_io.add_mapping_snapshot(self.mock_mapping_snapshot,
                                                          self.mapping_snapshot_data_io, self.mock_rrad_db_data_io,
                                                          self.mock_rehab_data_io, self.mock_rrad)
        self.mock_rrad.create_rehab_for_characterization.assert_called_with(self.mock_rrad_db_data_io)

    def test_add_mapping_snapshot_calls_add_rehab_with_correct_arguments(self):
        self.rrad_mapping_db_data_io.add_mapping_snapshot(self.mock_mapping_snapshot,
                                                          self.mapping_snapshot_data_io, self.mock_rrad_db_data_io,
                                                          self.mock_rehab_data_io, self.mock_rrad)
        self.mock_rrad_db_data_io.add_rehab.assert_called_with(self.mock_rehab, self.mock_rehab_data_io)
    ...
    def test_add_mapping_snapshot_no_exceptions_saved_changes_true_stop_editing_session_called_with_correct_arguments(self):
        save_changes = True
        self.rrad_mapping_db_data_io.add_mapping_snapshot(self.mock_mapping_snapshot,
                                                          self.mapping_snapshot_data_io, self.mock_rrad_db_data_io, self.mock_rehab_data_io, self.mock_rrad)
